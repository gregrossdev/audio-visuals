...
|-------|---------|-------|------------|--------|
| 1.1 | `0.1.1` | Project scaffold & Gradle config | in-session | done |
| 1.2 | `0.1.2` | Audio capture engine | in-session | done |
| 1.3 | `0.1.3` | FFT processor with Hann windowing | in-session | done |
| 1.4 | `0.1.4` | Bar spectrum Canvas renderer | in-session | done |
| 1.5 | `0.1.5` | Wire pipeline & main window | in-session | done |
