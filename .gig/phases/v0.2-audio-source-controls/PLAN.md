...
|-------|---------|-------|------------|--------|
| 2.1 | `0.2.1` | Refactor AudioCapture for device selection & gain | in-session | done |
| 2.2 | `0.2.2` | Dark theme & control bar layout | in-session | done |
| 2.3 | `0.2.3` | Device dropdown, gain slider & pause toggle | in-session | done |
| 2.4 | `0.2.4` | Wire controls to audio pipeline | in-session | done |
